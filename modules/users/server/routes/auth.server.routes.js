...
module.exports = function (app) {
  ...
  app.route('/api/auth/adminsignup').post(users.adminsignup);
  app.route('/api/auth/signupUser').post(users.signupUser);
  app.route('/api/auth/signin').post(users.signin);
  app.route('/api/auth/signout').get(users.signout);

  app.route('/api/addMachineExistingUser').post(users.addMachineExistingUsers);
